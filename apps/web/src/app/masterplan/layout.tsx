...
export default async function MasterPlanLayout({
	...
	if (!user) {
		redirect("/sign-in?redirect_url=/masterplan");
	}
						...
						<div className="space-y-5">
							...
							<div className="space-y-3">
								...
								<p className="max-w-3xl text-base leading-7 text-muted-foreground sm:text-lg">
									Strategy, operating doctrine, execution plans, and project
									docs. This surface now exposes the full authored markdown set
									behind the company thesis, not just the core `MASTER-PLAN`
									folder.
								</p>
							</div>
						...
						<div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
							<div className="rounded-[24px] border border-border/70 bg-secondary/50 p-4">
								...
								<p className="mt-2 text-sm leading-6 text-muted-foreground">
									The full repo-authored markdown set surfaced inside
									`/masterplan`.
								</p>
							</div>
							<div className="rounded-[24px] border border-border/70 bg-background p-4">
								...
								<p className="mt-2 text-sm leading-6 text-muted-foreground">
									The strategy order stays intact while additional project docs
									sit alongside it.
								</p>
							</div>
							<div className="rounded-[24px] border border-primary/20 bg-primary/5 p-4">
								...
								<p className="mt-3 text-sm leading-6 text-foreground/90">
									Start with the thesis, then move into doctrine, roadmap, GTM,
